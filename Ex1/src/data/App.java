...
public class App {
	...
	public static int listarDatas() {
		System.out.println("\nDatas j� criadas: \n"
				+ "Digite o código da data que deseja para realizar operações: ");
	...
	private static void operacoes() {
		...
		if(opcao > quantidadeDatas && opcao < 0) {
			...
			System.out.println("Escolha uma das op��es para a data: "+atual.toString()
					+ "\n1 - Comparar data\n"
			...
			switch(sc.nextInt()) {
				case 1:
					...
					System.out.println("A data mais recente entre essas duas op��es �: "+atual.compararData(new Data(data[0],data[1],data[2])).toString()+ "\n");
					break;
				case 2:
